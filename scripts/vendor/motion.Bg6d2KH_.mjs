import { r as e, t } from "./rolldown-runtime.DhnBybyj.mjs";
import {
  A as n,
  C as r,
  F as i,
...
function Re(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = lc.reduce((e, n) => ((e[n] = Le(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
...
function Je(e) {
  let t = We(e);
  return Ke(t)(t.values.map((e, n) => Gc(e, t.split[n])));
}
function Ye(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function pt(e = Y.visualDuration, t = Y.bounce) {
  ...
  let w = {
    ...
    toString: () => {
      let e = Math.min(ot(w), $c),
        t = Qc((t) => w.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function zt({ type: e, ...t }) {
  return Rt(e) && Fl() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Bt(e) {
  return e in zl;
}
function Vt(e) {
  typeof e.ease == `string` && Bt(e.ease) && (e.ease = zl[e.ease]);
}
function Ht(e) {
...
function yn(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Du.has(t) && We(t).values.length && (i = e[r]), r++);
  }
  ...
  let [r, i, a] = wn(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        s = (e) => {
          o(e, r === T || r === document || n.useGlobalTarget || Mu(r, e.target));
        },
        c = (e) => {
          o(e, !1);
        };
...
function In() {
  typeof ResizeObserver > `u` || (Bu = new ResizeObserver(Fn));
}
function Ln(e, t) {
  Bu || In();
  let n = bn(e);
  ...
  return (
    ...
    () => {
      (Wu.delete(e),
        !Wu.size &&
          typeof Gu == `function` &&
          (T.removeEventListener(`resize`, Gu), (Gu = void 0)));
    }
  );
}
function Bn(e, t) {
...
function $n(e) {
  return Zn(e.animate) || $u.some((t) => Qn(e[t]));
}
function er(e) {
...
function Pr(e, t, n, r) {
  for (let n in (Tr(e, t, void 0, r), t.attrs)) e.setAttribute(bd.has(n) ? n : ln(n), t.attrs[n]);
}
function Fr(e, t, n) {
  let r = kr(e, t, n);
  for (let n in e)
...
function ti(e, t, n, r) {
  (ei(e.x, t, Md, n ? n.x : void 0, r ? r.x : void 0),
    ei(e.y, t, Nd, n ? n.y : void 0, r ? r.y : void 0));
}
function ni(e) {
  ...
  return class {
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              Ud.hasAnimatedSinceResize &&
                ((Ud.hasAnimatedSinceResize = !1), this.nodes.forEach(ji)));
          }));
      }
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < Gd.length; t++)
        (vi(`rotate${Gd[t]}`, e, r, this.animationValues),
          vi(`skew${Gd[t]}`, e, r, this.animationValues));
...
function ia(e) {
  typeof e == `function` && (mf = (t) => (t.startsWith(`on`) ? !ra(t) : e(t)));
}
function aa(e, t, n) {
  let r = {};
  for (let i in e)
...
function ua(e) {
  let { initial: t, animate: r } = la(e, n(hf));
...
function ga(e, t, n, r) {
  let i = v(() => {
    let n = yf();
    return (Nr(n, t, xd(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function Qa(e) {
  let [t, r] = Xi(),
    i = n(As);
  return m(Vf, { ...e, layoutGroup: i, switchLayoutGroup: n(_f), isPresent: t, safeToRemove: r });
}
function $a(e, t, n) {
  let { props: r } = e;
...
function io(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > np ? 0 : Vs(i.current - s, l);
}
function ao(e, t, n) {
...
function mo(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !up.has(t))) {
    ...
    (T.addEventListener(`resize`, r),
      t !== document.documentElement && dp.set(t, Bn(t, r)),
...
function yo(e) {
  ...
  for (let [t, n] of gp) if (vo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function bo(e) {
  let t = { value: 0 };
  return {
...
function Oo(e, t) {
  return T === void 0 ? !1 : e ? Pl() && !!yo(t) : Nl();
}
      ...
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if (
          ...
          m &&
            Ps(
              m < Cp,
              `Sequence segments can't repeat ${m} times \u2014 ignoring repeat option. Use a value below ${Cp} or apply repeat at the sequence level instead.`
            ),
          m && m < Cp)
        ) {
          let e = b > 0 ? _ / b : 0;
...
function xs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  ...
  return m(s, {
    ...
    ref: h,
    ignoreStrict: !0,
    children: m(jp.Provider, { value: p, children: e }),
  });
}
function Ss(e, t) {
...
function ks(
  ...
  return m(u, {
    ...
    onDrag: (e, t) => {
      ...
      (_(r, f[h].get(), n[h]), Ds(v.current, i[h], h, n[h]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (Cs(), o && o(e, t));
    },
...
var As,
  ...
  Bp = t(() => {
    (o(),
      ...
      (sl = { decay: ht, inertia: ht, tween: St, keyframes: St, spring: pt }),
      (cl = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (ul = class extends cl {
        ...
        initAnimation() {
          ...
          s !== St &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Rs(ll, at(o[0], o[1]))), (o = [0, 100]));
      ...
      (Al = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (El.add(this), Dl || ((Dl = !0), B.read(Mt), B.resolveKeyframes(jt)))
      ...
      (jl = (e) => e.startsWith(`--`)),
      (Ml = {}),
      (Nl = Ft(() => T.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Pl = Ft(() => T.ViewTimeline !== void 0, `viewTimeline`)),
      (Fl = Ft(() => {
        try {
      ...
      (Gl = Ne(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Kl = (e, t) =>
        t === `zIndex`
          ? !1
          : !!(
      ...
      (Ou = class extends Al {
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = T.pageYOffset),
            (this.measuredOrigin = Tl[n](e.measureViewportBox(), T.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Tl[t](e.measureViewportBox(), T.getComputedStyle(e.current))),
      ...
      ({ schedule: Au, cancel: ju } = Re(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (td.current || nr(), (this.shouldReduceMotion = ed.current)),
      ...
      (hd = class extends od {
        ...
        readValueFromInstance(e, t) {
          if (xl.has(t)) return this.projection?.isProjecting ? Dt(t) : yl(e, t);
          {
            let n = Ar(e),
      ...
      (Sd = class extends od {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = bd.has(t) ? t : ln(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Fr(e, t, n);
        }
      ...
      (ef = bi({
        ...
        defaultParent: () => {
          if (!$d.current) {
            let e = new Zd({});
            (e.mount(T), e.setOptions({ layoutScroll: !0 }), ($d.current = e));
          }
          return $d.current;
        },
        resetTransform: (e, t) => {
      ...
      (nf = ({
        ...
        return (
          ...
          m(Ns.Provider, { value: h, children: e })
        );
      }),
      (rf = (e) => e.key || ``),
      (af = ({
      ...
      (lf = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        c.current === null &&
          (cf(r) && u && (t = t ? u + `-` + t : u),
          (c.current = { id: t, group: (sf(r) && i.group) || Wi() }));
    ...
    ((hf = a({})),
      ...
      (xf = gf({ scrapeMotionValuesFromProps: kr, createRenderState: vf })),
      (Sf = gf({ scrapeMotionValuesFromProps: Fr, createRenderState: yf })),
      ...
      (Of = (e) => (t) => Nu(t) && e(t, ka(t))),
      (kf = (e, t) => Math.abs(e - t)),
      (Af = (e, t) => ((t.isSVG ?? _a(e)) ? new Sd(t) : new hd(t, { allowProjection: e !== u }))),
      ...
      (Hf = { pan: { Feature: zf }, drag: { Feature: Lf, ProjectionNode: ef, MeasureLayout: Qa } }),
      (Uf = class extends sd {
        mount() {
      ...
      ($f = { layout: { ProjectionNode: ef, MeasureLayout: Qa } }),
      (ep = Oa({ ...Df, ...Qf, ...Hf, ...$f }, Af)),
      ...
      (pp = new WeakMap()),
      (mp = new WeakMap()),
      (hp = (e) => (e === document.scrollingElement ? T : e)),
      (gp = [
        [cp.Enter, `entry`],
        [cp.Exit, `exit`],
        [cp.Any, `cover`],
...
//# sourceMappingURL=motion.Bg6d2KH_.mjs.map
